                  ...
                  <Form onSubmit={this.handleSubmit} className="form-subscriptionFab">
                    ...
                    <Row type="flex" align="middle" justify="center">
                      <Col span={24} className="rec-plan-rate">
                        <Row type="flex" align="middle" justify="center">
                          <p className="sub-left-plan-name">Uwai F&B Plan</p>
                          ...
                          <Col span={12} className="m-view">
                            <Row type="flex" align="middle" justify="start">
                              <FormItem
                                ...
                                {...FormAlign}
                              >
                                { getFieldDecorator('business_type', { initialValue: 'F&B' })(
                                  <Input disabled />,
                                )}
                              </FormItem>
                            </Row>
...
SubscriptionFabForm.propTypes = {
  form: React.PropTypes.string.isRequired,
  intl: intlShape.isRequired,
};

const SubscriptionFab = Form.create()(injectIntl(SubscriptionFabForm));
