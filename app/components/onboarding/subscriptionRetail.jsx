...
class SubscriptionRetailForm extends Component {
  constructor(props) {
    super(props);
                  ...
                  <Form onSubmit={this.handleSubmit} className="form-subscriptionFab">
                    ...
                    <Row type="flex" align="middle" justify="center">
                      <Col span={24} className="rec-plan-rate">
                        <Row type="flex" align="middle" justify="center">
                          <p className="sub-left-plan-name">Uwai Retail Plan</p>
                          ...
                          <Col span={12} className="m-view">
                            <Row type="flex" align="middle" justify="start">
                              <FormItem
                                ...
                                {...FormAlign}
                              >
                                { getFieldDecorator('business_type', { initialValue: 'Retail' })(
                                  <Input disabled />,
                                )}
                              </FormItem>
                            </Row>
...
SubscriptionRetailForm.propTypes = {
  form: React.PropTypes.string.isRequired,
  intl: intlShape.isRequired,
};

const SubscriptionRetail = Form.create()(injectIntl(SubscriptionRetailForm));

export default SubscriptionRetail;
